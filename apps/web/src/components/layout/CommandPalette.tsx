...
const NAV_ITEMS = [
  ...
  { href: "/taxes", label: "Impostos & IR", icon: Receipt },
  { href: "/reports", label: "Relatórios", icon: FileText },
  { href: "/mobile-preview", label: "App mobile", icon: Smartphone },
  { href: "/ajuda", label: "Ajuda", icon: BookOpen },
];

/** ⌘K / Ctrl+K global, renderizada uma vez em PlatformShell.tsx dentro do
 * TourProvider. Coexiste com o campo "Buscar ticker" do TopBar em vez de
 * substituí-lo: são dois caminhos pro mesmo destino (a paleta é global e por
 * atalho, o campo é local à tela e visível o tempo todo), e não têm
 * data-tour associado em lib/tutorials.ts, então nenhum dos dois quebra tour
 * algum ao coexistir.
 *
 * Sem endpoint de busca de ticker por nome hoje (só cotação por ticker já
 * conhecido em market-api.ts) — "Ativos" aqui é indo direto para
