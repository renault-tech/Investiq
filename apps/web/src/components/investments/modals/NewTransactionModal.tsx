...
export function NewTransactionModal({
  ...
  return (
    ...
    >
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl w-[400px] p-5 animate-in fade-in slide-in-from-bottom-2 duration-150 max-h-[90vh] flex flex-col">
