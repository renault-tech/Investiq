"""Integration: contas a pagar — due_date separado de transaction_date e o
botão "Pagar".

O worker que notificava no vencimento (bill_due_checker) foi removido: quem
mostra conta vencendo agora é a Central de Ações (GET /actions), e ter as
duas coisas deixava a mesma conta em dois dropdowns vizinhos do TopBar."""
